<div class="container">
    ...
    <div class="question">
        ...
        <br>
        <h5>Do you feel you do too little, just enough or way too much additional physical activity?</h5><br>

        <form action="./index.php">

            <div class="slidecontainer">
                less<input type="range" min="1" max="5" value="3" class="slider" id="q5">more
            </div>
